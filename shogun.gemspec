...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "rack-body_serializer", "~> 1.0.0"
  spec.add_runtime_dependency "rack-body_deserializer", "~> 1.0.0"
  spec.add_runtime_dependency "rack-authentication_bearer", "~> 1.0.0"
  spec.add_runtime_dependency "rack-accept_setter", "~> 1.0.0"
  spec.add_runtime_dependency "rack-chunker", "~> 1.0.0"
  spec.add_runtime_dependency "rack-content_length_setter", "~> 1.0.0"
  spec.add_runtime_dependency "rack-runtime", "~> 1.0.0"
  spec.add_runtime_dependency "rack-log", "~> 1.0.0"
